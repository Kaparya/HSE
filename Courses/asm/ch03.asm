...
new_03h proc far
    ...
    jmp     dword ptr CS:[old_03h]  ; В системный обработчик без возврата
...
begin:
	...
	mov AX, 3503h
	int 21h
        mov word ptr old_03h,BX  ; ES:BX - вектор
...
uninstall:
    ...
    lds DX, old_03h   ; Эта команда эквивалентна следующим двум
