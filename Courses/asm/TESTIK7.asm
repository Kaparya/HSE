...
inst:
    ...
    iret
Pass_2Fh:
    jmp dword PTR CS:[all_2Fh_vector]
;
...
;    mov     DS, word ptr old_09h+2
    ...
    int     21h
;
    lds     DX, CS:all_2Fh_vector   ; Эта команда эквивалентна следующим двум
;    mov     DX, word ptr all_2Fh_vector
;    mov     DS, word ptr all_2Fh_vector+2
    mov     AX,252Fh
    int     21h
;
    pop     DS
...
;----------------------------------------------------------------------------
    ...
    mov word ptr all_2Fh_vector,BX    ;   ES:BX - вектор
    mov word ptr all_2Fh_vector+2,ES  ;
;
